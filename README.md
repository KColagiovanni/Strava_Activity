...
* Whenever there us a new commit pushed, there is a CI/CD pipeline in GitHub that runs the tests on the app using the same file mentioned above using [ci--cd.yml](.github/workflows/ci--cd.yml).
